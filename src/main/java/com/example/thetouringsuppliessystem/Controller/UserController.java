...
public class UserController {
    ...
    @PutMapping("/replace-product/{productidbefore}/{productidafter}/{userid}")
    public ResponseEntity replaceProduct(@PathVariable Integer productidbefore,@PathVariable Integer productidafter,@PathVariable Integer userid)
    {
        userService.ReplaceProduct(productidbefore, productidafter, userid);
