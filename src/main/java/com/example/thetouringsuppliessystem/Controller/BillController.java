...
public class BillController {
    ...
    public ResponseEntity updateOrder(@PathVariable Integer id, @Valid@RequestBody Bill bill, Errors errors)
    {
        if(errors.hasErrors())
        {
            String m = errors.getFieldError().getDefaultMessage();
...
//    @GetMapping("/get-product-by-order/{id}")
//    public ResponseEntity getProductsByBill(@PathVariable Integer id)
//    {
//        return ResponseEntity.status(200).body(billService.getProductsByBill(id));
//    }
