...
//        if(userRepository.findUserById(userID).getBalance() < productRepository.findProductById(productID).getPrice() + deliveryServiceRepository.findDeliveryServiceById(vendorRepository.findVendorById(productRepository.findProductById(productID).getVendorID()).getDeliveryServiceID()).getDeliveryCost())
//        {
